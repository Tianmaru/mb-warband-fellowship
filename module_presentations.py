...
("player2_init", 0, mesh_load_window,
    [
        ...
        [
            ...
            (create_simple_text_box_overlay, "$prsnt_player2_init_name"),
        ...
        [
            ...
            (else_try),
                ...
                (end_try),
                (overlay_set_display, "$prsnt_player2_init_portrait", 0),
                (overlay_set_val, "$prsnt_player2_init_portrait", "trp_player2"),
                (overlay_set_display, "$prsnt_player2_init_portrait", 1),
            (else_try),
                (eq, ":object", "$prsnt_player2_init_continue"),
                (call_script, "script_player2_init"),
                (presentation_set_duration, 0),
            (try_end),
        ]),
  ]),
