...
### FELLOWSHIP #################################################################
("player2_init", 0, mesh_load_window,
    [
        (ti_on_presentation_load,
        [
            (presentation_set_duration, 999999),
            ...
            (create_combo_button_overlay, "$prsnt_player2_init_gender"),
            (overlay_add_item, "$prsnt_player2_init_gender", "@Male"),
            (overlay_add_item, "$prsnt_player2_init_gender", "@Female"),
            (position_set_x, pos1, 1000),
            (position_set_y, pos1, 1000),
            (overlay_set_size, "$prsnt_player2_init_gender", pos1),
            (position_set_x, pos1, 725),
            (position_set_y, pos1, 600),
            (overlay_set_position, "$prsnt_player2_init_gender", pos1),

            (troop_get_type, ":gender", "trp_player2"),
            (try_begin),
                (eq, ":gender", tf_male),
                (overlay_set_val, "$prsnt_player2_init_gender", 0),
            (else_try),
                (eq, ":gender", tf_female),
                (overlay_set_val, "$prsnt_player2_init_gender", 1),
            (end_try),
            ...
            (create_text_box_overlay, "$prsnt_player2_init_name"),
            (position_set_x, pos1, 1000),
            (position_set_y, pos1, 1000),
            (overlay_set_size, "$prsnt_player2_init_name", pos1),
            (position_set_x, pos1, 725),
            (position_set_y, pos1, 550),
            (overlay_set_position, "$prsnt_player2_init_name", pos1),

            (str_store_troop_name, s0, "trp_player2"),
            (overlay_set_text, "$prsnt_player2_init_name", s0),

            (create_mesh_overlay_with_tableau_material, "$prsnt_player2_init_portrait", -1, "tableau_troop_note_mesh", "trp_player2"),
            (position_set_x, pos1, 1000),
            (position_set_y, pos1, 1000),
            (overlay_set_size, "$prsnt_player2_init_portrait", pos1),
            (position_set_x, pos1, 350),
            (position_set_y, pos1, 200),
            (overlay_set_position, "$prsnt_player2_init_portrait", pos1),

            (create_text_overlay, reg1,
            "@Hint: Your friends appearence is based on your currently selected multiplayer profile.",
            ...
            (create_game_button_overlay, "$prsnt_player2_init_continue", "@Continue together"),
            (position_set_x, pos1, 850),
            (position_set_y, pos1, 50),
            (overlay_set_position, "$prsnt_player2_init_continue", pos1),
        ]),
        ...
        [
            ...
            (store_trigger_param_2, ":value"),
            (try_begin),
                (eq, ":object", "$prsnt_player2_init_name"),
                (troop_set_name, "trp_player2", s0),
            (else_try),
                (eq, ":object", "$prsnt_player2_init_gender"),
                (try_begin),
                    (eq, ":value", 0),
            ...
            (else_try),
                (eq, ":object", "$prsnt_player2_init_continue"),
...
("fellowship_crosshair", prsntf_read_only|prsntf_manual_end_only, 0,
    [
        ...
        [
            ...
            #(overlay_set_additional_render_height, "$prsnt_player2_battle_crosshair", 1),
        ]),
