...
("fellowship_player2_init", 0, mesh_load_window,
    [
        ...
        [
            ...
            (troop_get_type, ":gender", "trp_player2"),
            (try_begin),
                (eq, ":gender", tf_male),
            ...
            (str_store_troop_name, s0, "trp_player2"),
            (overlay_set_text, "$prsnt_fellowship_player2_init_name", s0),

            (create_mesh_overlay_with_tableau_material, "$prsnt_fellowship_player2_init_portrait", -1, "tableau_troop_note_mesh", "trp_player2"),
            (position_set_x, pos1, 1000),
            (position_set_y, pos1, 1000),
        ...
        [
            ...
            (try_begin),
                ...
                (troop_set_name, "trp_player2", s0),
            (else_try),
                (eq, ":object", "$prsnt_fellowship_player2_init_gender"),
                (try_begin),
                    (eq, ":value", 0),
                    (troop_set_type, "trp_player2", tf_male),
                (else_try),
                    (eq, ":value", 1),
                    (troop_set_type, "trp_player2", tf_female),
                (end_try),
                #(presentation_set_duration, 0),
