...
### FELLOWSHIP #################################################################
("fellowship_player2_init", 0, mesh_load_window,
    [
        (ti_on_presentation_load,
        [
            (presentation_set_duration, 999999),
            ...
            (try_begin),
                (troop_set_face_key_from_current_profile, "trp_fellowship_player2"), # set face
            (end_try),
            ...
            (create_combo_button_overlay, "$prsnt_fellowship_player2_init_gender"),
            (overlay_add_item, "$prsnt_fellowship_player2_init_gender", "@Male"),
            (overlay_add_item, "$prsnt_fellowship_player2_init_gender", "@Female"),
            (position_set_x, pos1, 1000),
            (position_set_y, pos1, 1000),
            (overlay_set_size, "$prsnt_fellowship_player2_init_gender", pos1),
            (position_set_x, pos1, 725),
            (position_set_y, pos1, 600),
            (overlay_set_position, "$prsnt_fellowship_player2_init_gender", pos1),

            (troop_get_type, ":gender", "trp_fellowship_player2"),
            (try_begin),
                (eq, ":gender", tf_male),
                (overlay_set_val, "$prsnt_fellowship_player2_init_gender", 0),
            (else_try),
                (eq, ":gender", tf_female),
                (overlay_set_val, "$prsnt_fellowship_player2_init_gender", 1),
            (end_try),

            (create_text_overlay, reg1,
            "@Your friend is named:",
            tf_left_align),
            (position_set_x, pos1, 1500),
            (position_set_y, pos1, 1500),
            (overlay_set_size, reg1, pos1),
            ...
            (create_text_box_overlay, "$prsnt_fellowship_player2_init_name"),
            (position_set_x, pos1, 1000),
            (position_set_y, pos1, 1000),
            (overlay_set_size, "$prsnt_fellowship_player2_init_name", pos1),
            (position_set_x, pos1, 725),
            (position_set_y, pos1, 550),
            (overlay_set_position, "$prsnt_fellowship_player2_init_name", pos1),

            (str_store_troop_name, s0, "trp_fellowship_player2"),
            (overlay_set_text, "$prsnt_fellowship_player2_init_name", s0),

            (create_mesh_overlay_with_tableau_material, "$prsnt_fellowship_player2_init_portrait", -1, "tableau_troop_note_mesh", "trp_fellowship_player2"),
            (position_set_x, pos1, 1000),
            (position_set_y, pos1, 1000),
            (overlay_set_size, "$prsnt_fellowship_player2_init_portrait", pos1),
            (position_set_x, pos1, 350),
            (position_set_y, pos1, 200),
            (overlay_set_position, "$prsnt_fellowship_player2_init_portrait", pos1),

            (create_text_overlay, reg1,
            "@Hint: Your friends appearance is based on your currently selected multiplayer profile.",
            tf_left_align|tf_double_space),
            (position_set_x, pos1, 1500),
            (position_set_y, pos1, 1500),
            (overlay_set_size, reg1, pos1),
            (position_set_x, pos1, 50),
            ...
            (create_game_button_overlay, "$prsnt_fellowship_player2_init_continue", "@Continue together"),
            (position_set_x, pos1, 850),
            (position_set_y, pos1, 50),
            (overlay_set_position, "$prsnt_fellowship_player2_init_continue", pos1),
        ]),
        ...
        [
            ...
            (store_trigger_param_2, ":value"),
            (try_begin),
                (eq, ":object", "$prsnt_fellowship_player2_init_name"),
                (troop_set_name, "trp_fellowship_player2", s0),
            (else_try),
                (eq, ":object", "$prsnt_fellowship_player2_init_gender"),
                (try_begin),
                    (eq, ":value", 0),
                    (troop_set_type, "trp_fellowship_player2", tf_male),
                (else_try),
                    (eq, ":value", 1),
                    (troop_set_type, "trp_fellowship_player2", tf_female),
                (end_try),
                #(presentation_set_duration, 0),
            ...
            (else_try),
                ...
                (try_begin),
                    (neg|main_party_has_troop, "trp_fellowship_player2"),
                    (call_script, "script_recruit_troop_as_companion", "trp_fellowship_player2"),
                (end_try),
                (presentation_set_duration, 0),
            (try_end),
        ]),
