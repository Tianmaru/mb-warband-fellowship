...
fellowship_player2_control_init = (
	...
	[
		(main_party_has_troop, "trp_fellowship_player2"),
...
fellowship_camera_init = (
	...
	[
		...
		(set_camera_in_first_person, 0), # 1 = first, 0 = third person
...
fellowship_player2 = [fellowship_player_control, fellowship_player2_control_init, fellowship_player2_control, fellowship_camera_init, fellowship_camera, fellowship_battle_ui]
...
fellowship_player2_control_edit = (
	...
	[
		...
		(eq, ":talk_troop", "trp_fellowship_player2"),
...
# FELLOWSHIP # check if player 2 is still alive ################################
	   (assign, ":fellowship_player2_fallen", 0),
	   (try_begin),
	     (call_script, "script_cf_fellowship_player2_fallen"),
	     (assign, ":fellowship_player2_fallen", 1),
...
for mt in mission_templates:
	if mt[0] in fellowship_mission_templates:
		mt[5].extend(fellowship_player2)
